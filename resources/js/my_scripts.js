...
function loadStatsPage(){
	...
	//console.log(document.getElementById("wins").innerHTML);
...
function loadPlayersPage(){
	var txt = "";
	for (var playIn = 0; playIn < players.length; playIn++){
		txt += '<a class="dropdown-item" href="#" onclick="switchPlayers(' + playIn + ')">' + players[playIn].name + '</a>';
	}
